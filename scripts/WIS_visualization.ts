...
function animateDataDisplay(dataDisplay, jobScheduler) {
  ...
  /****************************************************** */
  {
    ...
    jobsUnsorted.forEach((job) => {
      ...
      animSequence.addOneBlock(TargetedTranslate(jobBarEl, startCell));
    });
    animSequence.addManyBlocks([
  ...
  /****************************************************** */
  {
    ...
    jobsUnsorted.forEach((job) => {
      const jobBarEl = job.getJobBar();
      animSequence.addOneBlock(TargetedTranslate(jobBarEl, jobBarsInitialArea, {blocksNext: false, blocksPrev: false}));
    });
  ...
  /****************************************************** */
  {
    ...
    jobsSorted.forEach((job) => {
      ...
      animSequence.addManyBlocks([
        TargetedTranslate(jobBarEl, startCell, {blocksNext: false}),
        Exit(rowUnsortedLetter, '~wipe-to-left', {blocksPrev: false, duration: 250}),
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      // [ 'line', freeLine_cArray, '~wipe-from-left', null, [0, 0.5], cArray, [1, 0.5] ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_cArray, '~wipe-to-left', null, [0, 0.5], cArray, [1, 0.5] ],
    ]);
    animTimeline.addOneSequence(animSequence);
  }
  ...
  jobsSorted.forEach((job) => {
    ...
    // MOVE CBAR TO CURRENT JOB BAR, UNHIDE IT, AND HIGHLIGHT CURRENT JOB BAR AND J ARRAY BLOCK
    {
      ...
      animSequence.addManyBlocks([
        TargetedTranslate(cBar, jobBarEl, {duration: 0}, {preserveY: true}),
    ...
    // MOVE CBAR, HIGHLIGHT COMPATIBLE JOB IF EXISTS, AND POINT TO C ARRAY
    {
      ...
      if (compatibleJobBarEl) {
        ...
        animSequence.addManyBlocks([
          TargetedTranslate(cBar, compatibleJobBarEl, {}, {alignmentX: 'right', preserveY: true}),
          Emphasis(compatibleJobBarEl, '~highlight'),
        ]);
        // animSequence2.addOneBlock(new AnimBlockLine(timeGraphArrowEl, '~wipe-from-top', rowSJNum, [1, 0.5], cBlock, [0.5, 0], {blocksPrev: false}));
      }
      ...
      // Then point arrow from bottom of cbar to current c-array entry
        ...
        animSequence.addManyBlocks([
          TargetedTranslate(cBar, timeGraphEl!, {}, {alignmentX: 'left', preserveY: true}),
        ]);
        // animSequence2.addOneBlock(new AnimBlockLine(timeGraphArrowEl, '~wipe-from-top', cBar, [0, 1], cBlock, [0.5, 0], {blocksPrev: false}));
      }
      ...
      animSequence2.addManyBlocks([
        Exit(cEntryBlank, '~wipe-to-left', {blocksPrev: false, blocksNext: false}),
    ...
    // HIDE CBAR AND ARROW AND UN-HIGHLIGHT EVERYTHING
    {
      ...
      if (compatibleJobBarEl) {
        animSequence.addManyBlocks([
          ...
          // [ 'line', timeGraphArrowEl, '~wipe-to-top', rowSJNum, [1, 0.5], cBlock, [0.5, 0], {blocksPrev: false, blocksNext: false} ]
        ]);
      }
      else {
        // animSequence.addOneBlock([ 'line', timeGraphArrowEl, '~wipe-to-top', cBar, [0, 1], cBlock, [0.5, 0], {blocksPrev: false, blocksNext: false} ]);
      }
      animSequence.addManyBlocks([
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      TargetedTranslate(textbox_showNaive, textbox_finishedCArray, {duration: 0}, { offsetTargetY: 1, offsetY: 10, offsetUnitsY: 'rem'}),
      // [ 'line', freeLine_showNaive, '~wipe-from-top', textbox_finishedCArray, [0.5, 1], null, [0.5, 0] ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      TargetedTranslate(textbox_explainNaive1, textbox_showNaive, {duration: 0}, {offsetTargetY: 1, offsetY: 10, offsetUnitsY: 'rem', offsetTargetX: -1.0, offsetX: 10, offsetUnitsX: 'rem'}),
      Emphasis(algorithm_term1, '~highlight'),
      // [ 'line', freeLine_explainNaive1, '~wipe-from-top', algorithm_term1, [0.5, 1], null, [0.5, 0] ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.setTag('explain naive');
    animSequence.addManyBlocks([
      TargetedTranslate(textbox_explainNaive2, textbox_showNaive, {duration: 0}, {offsetTargetY: 1, offsetY: 10, offsetUnitsY: 'rem', offsetTargetX: 1.0, offsetX: -10, offsetUnitsX: 'rem', alignmentX: 'right'}),
      Emphasis(algorithm_term2, '~highlight'),
      // [ 'line', freeLine_explainNaive2, '~wipe-from-top', algorithm_term2, [0.5, 1], null, [0.5, 0] ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_explainNaive1, '~wipe-to-top', algorithm_term1, [0.5, 1], null, [0.5, 0], {blocksNext: false} ],
      // [ 'line', freeLine_explainNaive2, '~wipe-to-top', algorithm_term2, [0.5, 1], null, [0.5, 0], {blocksNext: false, blocksPrev: false} ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      TargetedTranslate(textbox_explainNaiveBad, textbox_showNaive, {duration: 0}, {offsetTargetY: 1, offsetY: 10, offsetUnitsY: 'rem'}),
      // [ 'line', freeLine_explainNaiveBad, '~wipe-from-top', textbox_showNaive, [0.5, 1], null, [0.5, 0] ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      // [ 'line', freeLine_MArray, '~wipe-from-left', null, [0, 0.5], MArray, [1, 0.5] ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      TargetedTranslate(textbox_showMemoized, textbox_MArray, {duration: 0}, {offsetTargetX: 1, offsetX: 20, offsetUnitsX: 'rem', preserveY: true}), // TODO: Fix unit
      // [ 'line', freeLine_showMemoized, '~wipe-from-left', textbox_MArray, [1, 0.5], null, [0, 0.5] ],
...
function animateJobCard(jobCard, parentAnimSequence, parentArrowDown, parentArrowSource, aboveBullet) {
  ...
  /****************************************************** */
  {
    ...
    if (parentArrowDown) {
      animSequence.addManyBlocks([
        // [ 'line', parentArrowDown, '~wipe-from-top', parentArrowSource, [0, 1], SJNumLabel, [0.5, -0.2], {blocksPrev: false} ],
      ]);
    }
    if (aboveBullet) {
      const freeLine_bulletConnector = jobCard.querySelector('.free-line--bullet-connector');
      animSequence.addManyBlocks([
        // [ 'line', freeLine_bulletConnector, '~wipe-from-top', aboveBullet, [0.5, 0.5], jobCardBullet, [0.5, 0.5] ],
      ]);
    }
    animSequence.addManyBlocks([
      Entrance(MAccess, '~fade-in'),
      Emphasis(MAccessContainer, '~highlight', {blocksNext: false, blocksPrev: false}),
      // [ 'line', freeLine_MAccess, '~wipe-from-bottom', MAccess, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
  ...
  /****************************************************** */
  {
    ...
    // animSequence.addOneBlock([ 'line', freeLine_toMBlock, '~wipe-from-right', MAccessContainer, [0, 0.5], MBlock, [0.9, 0.5], {lineOptions: {trackEndpoints: true}} ]);
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      // [ 'line', freeLine_toMBlock, '~wipe-to-right', MAccessContainer, [0, 0.5], MBlock, [0.9, 0.5], {lineOptions: {trackEndpoints: true}} ],
      Exit(textbox_MAccess, '~fade-out', {blocksNext: false}),
      // [ 'line', freeLine_MAccess, '~wipe-to-bottom', MAccess, [0.5, -0.2], null, [0.5, 1], {blocksNext: false} ],
      ...
      // [ 'line', freeLine_formulaComputation, '~wipe-from-bottom', formulaComputation, [0.1, 0.2], null, [0.5, 1], {blocksPrev: false} ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_formulaComputation, '~wipe-to-bottom', formulaComputation, [0.1, 0.2], null, [0.5, 1], {blocksNext: false} ],
      Emphasis(formulaComputation, '~un-highlight', {blocksPrev: false}),

      Emphasis(computationExpression1, '~highlight', {blocksNext: false}),
      // [ 'line', freeLine_computation1, '~wipe-from-bottom', computation1, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_computation1, '~wipe-to-bottom', computation1, [0.5, -0.2], null, [0.5, 1], {blocksNext: false} ],
      ...
      // [ 'line', freeLine_cAccess, '~wipe-from-bottom', cAccessContainer, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      // [ 'line', freeLine_toCBlock, '~wipe-from-right', cAccessContainer, [0, 0.5], cBlock, [0.9, 0.5], {blocksPrev: false, lineOptions: {trackEndpoints: true}} ],
    ]);
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_toCBlock, '~wipe-from-left', cBlock, [0.9, 0.5], cAccessContainer, [-0.1, 0.5], {lineOptions: {trackEndpoints: true}} ],
      // [ 'line', freeLine_cAccess, 'updateEndpoints', cAccessContainer, [0.5, -0.2], null, [0.5, 1] ],
      Exit(cAccess, '~wipe-to-left', {blocksPrev: false}),
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_cAccess, '~wipe-to-bottom', cAccessContainer, [0.5, -0.2], null, [0.5, 1], {blocksNext: false} ],
      ...
      // [ 'line', freeLine_OPTExpression1, '~wipe-from-bottom', OPTExpressionContainer1, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
  ...
  let sourceEl_OPT1, freeLine_fromSourceEl1; // pointing up from child
  {
    ...
    animSeqPassDown.addManyBlocks([
      ...
      // [ 'line', freeLine_OPTExpression1, '~wipe-to-bottom', cAccessContainer, [0.5, -0.2], null, [0.5, 1] ],
    ]);
    let animSequence;
    ...
    animSequence.addManyBlocks([
      // [ 'line', freeLine_fromSourceEl1, '~wipe-from-bottom', sourceEl_OPT1, [0.5, -0.2], OPTExpressionContainer1, [0, 1.1] ],
      Exit(OPTExpression1, '~wipe-to-left', {blocksPrev: false}),
      ...
      // [ 'line', freeLine_OPTExpression1, '~wipe-from-bottom', OPTResult1, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
      Entrance(textbox_OPTExpression1, '~fade-in', {blocksPrev: false}),
    ]);
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_OPTExpression1, '~wipe-to-bottom', OPTExpressionContainer1, [0.5, -0.2], null, [0.5, 1], {blocksNext: false} ],
      ...
      Exit(computationExpression1, '~wipe-to-left',),
      Entrance(computationResult1, '~wipe-from-right',),
      Emphasis(computationResult1, '~highlight', {blocksPrev: false, blocksNext: false}),
      // [ 'line', freeLine_computation1, '~wipe-from-bottom', computationResult1, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
      Entrance(textbox_computation1, '~fade-in', {blocksPrev: false}),
    ]);
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      Exit(textbox_computation1, '~fade-out', {blocksNext: false}),
      // [ 'line', freeLine_computation1, '~wipe-to-bottom', computationResult1, [0.5, -0.2], null, [0.5, 1], {blocksNext: false} ],
      Emphasis(computationResult1, '~un-highlight', {blocksPrev: false}),

      Emphasis(computation2, '~highlight', {blocksNext: false}),
      // [ 'line', freeLine_computation2, '~wipe-from-bottom', computation2, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_computation2, '~wipe-to-bottom', computation2, [0.5, -0.2], null, [0.5, 1], {blocksNext: false} ],
  
      Exit(nextSJNumExpression, '~wipe-to-left'),
      Entrance(nextSJNum, '~wipe-from-right'),
  
      // [ 'line', freeLine_OPTExpression2, '~wipe-from-bottom', computation2, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
  ...
  let sourceEl_OPT2, freeLine_fromSourceEl2; // pointing up from child
  {
    ...
    animSeqPassDown.addManyBlocks([
      ...
      // [ 'line', freeLine_OPTExpression2, '~wipe-to-bottom', computation2, [0.5, -0.2], null, [0.5, 1] ],
    ]);
    let animSequence;
    ...
    animSequence.addManyBlocks([
      // [ 'line', freeLine_fromSourceEl2, '~wipe-from-bottom', sourceEl_OPT2, [0.5, -0.2], computation2, [0, 1.1] ],
      ...
      Exit(OPTExpression2, '~wipe-to-left', {blocksPrev: false}),
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_formulaComputation, '~wipe-from-bottom', formulaContainer, [0.5, 0], null, [0.5, 1], {blocksPrev: false} ],
      Entrance(textbox_formulaComputation, '~fade-in', {blocksPrev: false}),
    ]);
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      Exit(formulaComputation, '~wipe-to-left', {blocksPrev: false}),
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      Exit(textbox_formulaComputation, '~fade-out', {blocksNext: false}),
      // [ 'line', freeLine_formulaComputation, '~wipe-to-bottom', formulaContainer, [0.5, -0.2], null, [0.5, 1], {blocksNext: false} ],
      Emphasis(formulaContainer, '~un-highlight', {blocksNext: false}),
      Exit(formulaContainer, '~wipe-to-left'),
      Exit(arrowContainer, '~wipe-to-left'),
  
      // Visually update M access to final answer
      Exit(MAccess, '~wipe-to-left'),
      Entrance(MEntry, '~wipe-from-right'),
      Emphasis(MAccessContainer, '~highlight'),
  
      // Visually update M array entry
      // [ 'line', freeLine_toMBlock, '~wipe-from-right', MAccessContainer, [0, 0.5], MBlock, [0.9, 0.5], {lineOptions: {trackEndpoints: true}} ],
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_toMBlock, '~wipe-to-right', MAccessContainer, [0, 0.5], MBlock, [0.9, 0.5], {lineOptions: {trackEndpoints: true}} ],
      // [ 'line', freeLine_MAccess, '~wipe-from-bottom', MAccessContainer, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false, lineOptions: {trackEndpoints: true}} ],
      Entrance(textbox_MAccess, '~fade-in', {blocksPrev: false}),
    ]);
  ...
  if (parentArrowDown) {
    ...
    animSequence.addManyBlocks([
      Exit(textbox_MAccess, '~fade-out', {blocksNext: false}),
      // [ 'line', freeLine_MAccess, '~wipe-to-bottom', MAccessContainer, [0.1, 0.2], null, [0.5, 1] ],
...
function animateJobStub(jobCard, parentAnimSequence, parentArrowDown, parentArrowSource, aboveBullet) {
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      Entrance(MAccess, '~fade-in'),
      Emphasis(MAccessContainer, '~highlight', {blocksNext: false, blocksPrev: false}),
      // [ 'line', freeLine_MAccess, '~wipe-from-bottom', MAccessContainer, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false} ],
      Entrance(textbox_MAccess, '~fade-in', {blocksPrev: false}),
    ]);
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_toMBlock, '~wipe-from-left', MBlock, [0.9, 0.5], MAccessContainer, [0, 0.5], {lineOptions: {trackEndpoints: true}} ],
      Exit(MAccess, '~wipe-to-left'),
      Entrance(MEntry, '~wipe-from-right'),
  ...
  /****************************************************** */
  {
    ...
    animSequence.addManyBlocks([
      ...
      // [ 'line', freeLine_MAccess, '~wipe-to-bottom', MAccessContainer, [0.5, -0.2], null, [0.5, 1], {blocksPrev: false, blocksNext: false} ],
